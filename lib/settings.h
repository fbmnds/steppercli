...
static const float damp_coeff[DAMP_COEFF_LEN] = {
    0.0014, 0.0056, 0.0126, 0.0224, 0.0350, 0.0503, 0.0685, 0.0894,
    0.1131, 0.1394, 0.1684, 0.2001, 0.2342, 0.2707, 0.3095, 0.3505,
    0.3933, 0.4378, 0.4838, 0.5308, 0.5785, 0.6265, 0.6742, 0.7213,
    0.7670, 0.8108, 0.8519, 0.8897, 0.9232, 0.9517, 0.9744, 0.9904
};
